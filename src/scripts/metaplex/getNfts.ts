...
// const pubKey = new web3.PublicKey("6mszaj17KSfVqADrQj3o4W3zoLMTykgmV37W4QadCczK") //Claynosaurz collection
...
async function getNfts(
  ...
  //     mint
  //   );
  //   const tokenAccount = await getAccount(connection, largestAccounts.value[0].accounts)
